...
- `Images.jsx` (`/images`): 접속 가능한 컨테이너 인프라가 배포중인 실제 이미지 파일들과 그에 따른 부가 속성(해시값 등)을 나열합니다. 새로 추가된 체크박스 기능을 통해 불필요한 태그를 다중 선택하여 일괄 삭제(Batch Delete) 할 수 있으며, 중요 태그는 원클릭 [Protect] 토글 기능으로 신속하게 보호할 수 있습니다.
